const BtcNetworkHelper = require('./BtcNetworkHelper');
        ...
        return new Promise(async(resolve,reject)=>{
            try{
                ...
                if(balance >= amount+fee){
                    ...
                    console.error("Insufficient balance: trying to send "+amount+" BTC + "+fee+" BTC fee when having "+balance+" BTC")
                    throw WRONG_FEE;
                }
            }catch(e){
                return reject(e);
        ...
        return new Promise(async(resolve,reject)=>{
            try{
                ...
                try{
                    ...
                    console.log('postRequest after response',e)
